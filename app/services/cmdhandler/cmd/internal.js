...
exports.mine_armed = async function mine_armed(cmd) {
    cmdBuilder.begin()
    let tmpCmd = cmdBuilder.getTmpCmd()
    cmdBuilder.addMessage('global', ':[TRAPS]: ・ If you have just placed a mine, please note that this is only allowed in and immediately around your Base. Remove the mine if this is not the case.')
    return cmdBuilder.fullCommand(tmpCmd)
}
